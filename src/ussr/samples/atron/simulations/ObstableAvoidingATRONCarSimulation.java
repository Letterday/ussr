 ...
 */
public class ObstableAvoidingATRONCarSimulation extends GenericATRONSimulation {
    ...
    public static void main( String[] args ) {
		...
		new ObstableAvoidingATRONCarSimulation().main();
    }
	...
	protected Robot getRobot() {
        ...
        ATRON robot = new ATRON() {
            public Controller createController() {
                return new ObstacleAvoidingATRONCarController();
            }
        };
        robot.setGentle();
        return robot;
