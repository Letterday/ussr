...
,Right_0,Right_1,Right_2,Right_3,Right_4,Right_5,Right_6,Right_7,Right_8,Right_9,Right_10,Right_11,Right_12,Right_13,Right_14,Right_15,Right_16,Right_17,Right_18;
	...
	public static int length(Grouping g) {
		int j = 0;
		while (!values()[j].toString().startsWith(g.toString() + "_")) {
			j++;
		}
		return j;
	}
