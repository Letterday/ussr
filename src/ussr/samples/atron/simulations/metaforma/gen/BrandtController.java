...
//
//class BrandtSimulation extends MetaformaSimulation {
//	
...
//}
//
//public class BrandtController extends MetaformaRuntime implements ControllerInformationProvider {
//
...
//		if (nbs(EAST&MALE).nbsInRegion(true).size() == 2 ) {
//			if (nbs(WEST&SOUTH&MALE).nbsInRegion(true).isEmpty() || nbs(EAST&FEMALE).nbsInRegion(true).size() == 2 && nbs(WEST&NORTH&FEMALE).nbsInRegion(true).isEmpty()){
//				sourceH = true;
//			}
//			if (nbs(WEST&NORTH&MALE).nbsInRegion(true).isEmpty() || nbs(WEST&FEMALE).nbsInRegion(true).size() == 2 && nbs(EAST&NORTH&FEMALE).nbsInRegion(true).isEmpty()) {
//				sourceV = true;
//			}
//		}
//		
