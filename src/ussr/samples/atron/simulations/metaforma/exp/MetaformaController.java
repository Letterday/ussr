...
//
//	protected String getVar(Module m, String name) {
//		if (getId() == m) {
...
//	}
//	
//	protected void setVar (Module id, String name, String value) {
//		if (id.equals(getId())) {
//			vars.put(name, value);
//		}
//	}
...
//		if (neighbors.get(nb.getGrouping()).containsKey(nb)) {
...
//	}
//
//	public void connection(Module dest, boolean makeConnection,boolean autoNextState) {
//		info.addNotification("#(dis)connection to " + dest);
//		keepSending(dest);
//		info.addNotification("done keepsending");
//		byte conToNb = getConnectorToNb(dest);
//		byte conFromNb = getConnectorFromNb(dest);
...
//		if (getId() == m1) {
//			connection(m2,makeConnection,autoNextState);
//		}
//			
//			
//	}
...
//		broadcast(new MetaformaPacket(getId(), Module.ALL).setType(Type.DISCOVER));
//		delay(2000);
//	}
///*
// * Check whether a connector constraint satisfies. The connectorNrs must be connected
// */
////  protected boolean connConstr(Byte[] connectorNrs) {
////	  Collection<HashMap<Module,Byte[]>> c = neighbors.values();
////	   int found = 0;
////	    Iterator<HashMap<Module,Byte[]>> grouping = c.iterator();
////	   
////	    //iterate through HashMap values iterator
////	    while(grouping.hasNext()) {
////	    	HashMap<Module,Byte[]> nbs = grouping.next();
////	    	Iterator<Byte[]> conns = nbs.values().iterator();
////	    	 while(conns.hasNext()) {
////		    	Byte[] cc = conns.next();
////		    	for (int i = 0; i< connectorNrs.length; i++) {
////			      if (cc[0] == connectorNrs[i]) {
////			    	  found++;
////			      }
////			      else {
////			    	  found--;
...
////		    }
////	    }
////	    info.addNotification("found " + found + " of " + connectorNrs.length);
////	    return (found == 0);
//	  
////	  for (int i=0; i<connectorNrs.length; i++) {
////		  
...
//		//info.addNotification(".disconnect(" + m1 + "," + m2 + ")");
//		connection(getId(), dest, false, true);
//		connection(dest, getId(), false, true);
//	}
//	
//	
//
...
//	}
//	
//	protected void resetState(int newState) {
//		state = newState-1;
//		info.addNotification("State reset to " + newState);
//		initNewState();
//		
//		delay(1000);
//		broadcast(new MetaformaPacket(getId(), Module.ALL).setType(Type.STATERESET).setData(state));
//	}
//
//	
...
//				}
//				
//				if (p.getType() == Type.STATERESET && state >= p.getData()) {
//					resetState(p.getData());
//					broadcast(new MetaformaPacket(p).setData(state).setType(Type.STATE).setDest(Module.ALL),connector);
//				}
//
